# -*- encoding: utf-8 -*-
# stub: cucumber-core 3.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-core-3.1.0".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<gherkin>.freeze, [">= 5.0.0"])
      ...
      s.add_dependency(%q<gherkin>.freeze, [">= 5.0.0"])
