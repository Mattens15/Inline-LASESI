...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-3.1.1".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<cucumber-core>.freeze, ["~> 3.1.0"])
      s.add_runtime_dependency(%q<cucumber-expressions>.freeze, ["~> 6.0.0"])
      ...
      s.add_dependency(%q<cucumber-core>.freeze, ["~> 3.1.0"])
      s.add_dependency(%q<cucumber-expressions>.freeze, ["~> 6.0.0"])
