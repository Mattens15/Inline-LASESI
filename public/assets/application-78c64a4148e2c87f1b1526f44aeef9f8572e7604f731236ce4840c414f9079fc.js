...
(function() {
  ...
  mapbox_api = function() {
    ...
    map = new mapboxgl.Map({
      container: 'map',
      center: [12.4781985, 42.2058305],
      style: 'mapbox://styles/mapbox/streets-v9',
      zoom: 2
    });
    map.addControl(new MapboxGeocoder({
      accessToken: 'pk.eyJ1IjoibGV0c2ZlZCIsImEiOiJjamhkamxmYXcwNTBvMzBva3VyOG50NjFtIn0.EuqkJJgJMWazgpxc6YJp4A'
    }));
            ...
            'features': [
              {
                ...
                'geometry': {
                  'type': 'Point',
                  'coordinates': [12.602005004882812, 42.178670521216]
                },
                'properties': {
                  'title': 'Room1',
                  'icon': 'harbor'
